...
public class WarriorInput : MoveCharacterInput
{
    public override void MoveSetting()
    {
        ...
        _characterSystem.Move<WarriorRuntimeData>(_id, _characterView, gameObject, _targetGameObject, _astar);
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            _characterSystem.Damage<WarriorRuntimeData>(_id, other.GetComponent<AttackField>().Runtime, _characterView);
        }
    }
}
